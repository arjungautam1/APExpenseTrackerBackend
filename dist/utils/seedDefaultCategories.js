...
exports.seedDefaultCategories = void 0;
const Category_1 = __importDefault(require("../models/Category"));
const seedDefaultCategories = async () => {
    try {
        // Check if default categories already exist
        const existingCount = await Category_1.default.countDocuments({ isDefault: true });
        if (existingCount > 0) {
        ...
        await Category_1.default.insertMany(defaultCategories.map(cat => ({
            ...cat,
            isDefault: true
        })));
